...
export default function CodeBlockDemo() {
  ...
  return (
    ...
    return (_jsx("div", { className: "w-full max-w-2xl p-6", children: _jsx(CodeBlock, { code: code, language: "jsx", children: _jsx(CodeBlockCopyButton, { onCopy: () => console.log('Copied code to clipboard'), onError: () => console.error('Failed to copy code to clipboard') }) }) }));
}
